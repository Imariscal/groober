...
import { createVaccine } from '@/api/ehr-api';
...
export function CreateVaccineModal({ isOpen, onClose, onSuccess }: CreateVaccineModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.message || 'Error al crear vacuna');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="sticky top-0 z-20 bg-gradient-to-r from-primary-600 via-primary-600 to-primary-700 px-6 py-4 flex items-center justify-between border-b border-primary-600 shadow-sm">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-1">
                ...
                <h2 className="text-2xl font-bold text-white">Nueva Vacuna</h2>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Ej: Vacuna contra el parvovirus canino..."
                    rows={3}
