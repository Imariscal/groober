# ============================================================
# Groober Beta - Azure Deploy Script
...
$environment = "beta"
$prefix = "groober"
$dbAdmin = "groober_admin"
$dbPassword = -join ((33..126) | Get-Random -Count 32 | % {[char]$_})
$dbName = "groober_beta"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Groober Beta - Azure Deploy" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$registryName = "groober$(Get-Random -Minimum 10000 -Maximum 99999)"
az acr create `
  --resource-group $resourceGroup `
  --name $registryName `
  --sku Basic
...
$credentials = @"
# GROOBER BETA - CREDENCIALES AZURE
...
$credentials | Out-File -FilePath "GROOBER_CREDENTIALS_BETA.env" -Encoding UTF8 -Force
...
Write-Host "   1. Credenciales guardadas en: GROOBER_CREDENTIALS_BETA.env" -ForegroundColor Yellow
Write-Host "   2. GUARDAR EN PASSWORD MANAGER" -ForegroundColor Red
Write-Host "   3. NO COMMITEAR A GIT" -ForegroundColor Red
Write-Host "   4. Agregar a .gitignore: GROOBER_CREDENTIALS_BETA.env" -ForegroundColor Red
Write-Host ""
...
Write-Host "   4. Hacer push del codigo" -ForegroundColor Yellow
Write-Host ""
